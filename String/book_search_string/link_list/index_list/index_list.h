...
void Insert_Index_List(Index_list list ,char * number );
void Delete_Index_List(Index_list list ,char *  number);
Index_position Find_Index_Position(Index_list list , char * number );
